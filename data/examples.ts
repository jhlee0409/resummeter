...
export const resumeExamples: ResumeExample[] = [
  ...
  // 영업
  {
    ...
    level: 'senior',
    section: '경력 기술',
    title: '엔터프라이즈 신규 시장 개척',
    content: `SaaS 협업 솔루션의 제조업 신규 시장을 개척했습니다. 콜드 아웃리치와 업계 세미나를 통해 잠재 고객 120곳을 발굴하고, 의사결정 구조를 분석해 핵심 이해관계자별 맞춤 제안을 진행했습니다. 그 결과 연간 매출 목표 35억 대비 125%(43.7억)를 달성하고, 신규 고객사 35곳을 확보했습니다. 특히 6개월 이상 검토하던 대형 제조사 3곳과 연 5억 규모 계약을 체결했고, 이탈 위기 고객 2곳을 리텐션 전략으로 유지해 갱신율을 92%로 끌어올렸습니다.`,
    analysis: {
      strengths: ['목표 대비 달성률 명시(125%)', '딜 규모·고객 수 정량화', '신규 개척+리텐션 균형'],
      keywords: ['B2B 영업', '신규 개척', '클로징', '리텐션', '갱신율', '매출 목표'],
      pattern: '시장 발굴 → 이해관계자 분석 → 맞춤 제안 → 정량 성과(매출·갱신율)',
    },
  },
  // 마케팅
  {
    ...
    level: 'junior',
    section: '프로젝트 경험',
    title: '데이터 기반 광고 ROAS 개선',
    content: `월 광고비 8천만 원 규모의 앱 설치 캠페인을 운영하며 ROAS를 개선했습니다. GA4와 GTM으로 퍼널을 분석해 가입 전환 이탈 구간을 특정하고, 메타·구글 매체별 타겟과 소재를 A/B 테스트했습니다. 8주간 12개 소재 변형을 검증해 클릭률(CTR)을 1.2%에서 2.8%로, 설치당 비용(CPI)을 4,200원에서 2,600원으로 낮췄습니다. 그 결과 동일 예산 대비 월 신규 설치를 1.6배(월 1.9만 → 3.0만)로 늘렸고, ROAS를 180%에서 320%로 개선했습니다.`,
    analysis: {
      strengths: ['예산 규모 명시', 'CTR/CPI/ROAS Before-After', '가설 검증 과정(A/B)'],
      keywords: ['퍼포먼스 마케팅', 'ROAS', 'CPI', 'A/B 테스트', 'GA4', '퍼널 분석'],
      pattern: '데이터 진단 → 가설·실험 → 지표 개선(CTR/CPI) → 비즈니스 성과(ROAS)',
    },
  },
  // 디자인
  {
    ...
    level: 'senior',
    section: '프로젝트 경험',
    title: '커머스 결제 플로우 UX 개선',
    content: `커머스 앱의 결제 이탈 문제를 UX 리서치 기반으로 해결했습니다. 유저 인터뷰 12건과 행동 로그(Amplitude) 분석으로 3단계 결제 과정의 이탈 지점을 특정하고, 단계를 1페이지로 재설계했습니다. 프로토타입 사용성 테스트와 A/B 테스트를 거쳐 출시한 결과, 결제 이탈률을 42% 낮추고 전환율을 18% 높였습니다. 동시에 흩어져 있던 UI를 토큰 기반 디자인 시스템(컴포넌트 120여 개)으로 통합해 디자인-개발 핸드오프 시간을 35% 단축했습니다.`,
    analysis: {
      strengths: ['리서치 근거(인터뷰·로그)', '전환율·이탈률 정량화', '디자인 시스템 기여'],
      keywords: ['UX 리서치', '사용성 테스트', '전환율', '디자인 시스템', '프로토타이핑', 'A/B 테스트'],
      pattern: '문제 발견(리서치) → 재설계 → 검증(테스트) → 성과(전환율) + 시스템 기여',
    },
  },
  // 의료
  {
    ...
    level: 'junior',
    section: '경험 기술',
    title: '내과 병동 환자 안전 관리',
    content: `상급종합병원 내과 병동에서 2년간 근무하며 일 평균 15명의 입원 환자를 담당했습니다. 다약제 복용 환자가 많은 병동 특성상 투약 안전에 집중해 5 Rights 확인 절차를 철저히 지켜 2년간 투약 오류 0건을 유지했습니다. 활력징후 변화와 처방 수행을 EMR에 정확히 기록·인계해 야간 응급 상황 대응 시간을 단축했고, 환자·보호자 교육 자료를 개선해 담당 병동 환자 만족도 조사 1위에 기여했습니다. 신규 간호사 프리셉터로 6개월간 1:1 교육을 맡아 조기 적응을 도왔습니다.`,
    analysis: {
      strengths: ['환자 수·근무 기간 명시', '투약 오류 0건 등 안전 지표', '교육·인계 기여'],
      keywords: ['환자 안전', '투약 관리', '5 Rights', 'EMR', '프리셉터', '환자 교육'],
      pattern: '담당 규모 → 안전 관리 절차 → 정량 성과(오류 0건·만족도) → 팀 기여(교육)',
    },
  },
];
...
export const exampleIndustries = ['IT', '금융', '제조', '공공', '영업', '마케팅', '디자인', '의료'] as const;
