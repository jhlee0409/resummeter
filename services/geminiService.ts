...
import { CoachingResult, GithubRepo, TailoredInstructionWithRequirements, GitHubFetchResult, NarrativeFramework, NarrativeSectionSpec, NarrativeSectionResult, NarrativeGenerationResult, NarrativeAnalysis, KStarKBreakdown, TechNarrativeBreakdown, CompanyContext } from "../types";
import { formatCompanyContext } from './companyResearchService';
import { formatRepoInfo } from '../shared/prompt/formatters';
// Re-export formatRepoInfo for existing consumers
...
// ─────────────────────────────────────────────────────────────
// Re-exports from core/analysis for backward compatibility
// ─────────────────────────────────────────────────────────────
